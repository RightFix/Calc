...
from assets.pages.calculator import CalculatorScreen
from assets.pages.tvm import TVMScreen
from assets.pages.assets_val import AssetsValScreen
from assets.pages.scientific import SciScreen
